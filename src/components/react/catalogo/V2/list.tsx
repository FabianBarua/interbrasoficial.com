...
const FixedPromoPriceViewComponent = ({
  ...
  return (
    <div className="flex flex-col items-start">
      ...
      <h3 className="text-sm  text-green-500 bg-green-100 border border-green-700 px-4 py-0 rounded-lg shadow-md">
        <span className=" ">
            USD
        </span> 
      ...
      {products
        ...
        .map((product) => {
          return (
            ...
            >
              {
                // TODO: DESCOMENTAR EN V2
              }
              {/* {
                product.promotion.type?.name === "fijo" && <>
                  <div className="absolute top-2 right-2 bg-orange-100 border border-orange-700 px-4 py-0 rounded-2xl shadow-md">
